...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.algorithmhub.ModelName = factory(root.algorithmhub.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ModelName</code>.
   * @alias module:model/ModelName
   * @class
   * @param wsid {String} 
   * @param inputs {Object} 
   * @param f {String} 
  ...
  /**
   * Constructs a <code>ModelName</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelName} obj Optional instance to populate.
   * @return {module:model/ModelName} The populated <code>ModelName</code> instance.
   */
