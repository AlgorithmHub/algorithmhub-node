...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new algorithmhub.InlineResponseDefault();
  });
  ...
  describe('InlineResponseDefault', function() {
    it('should create an instance of InlineResponseDefault', function() {
      ...
      //var instane = new algorithmhub.InlineResponseDefault();
      //expect(instance).to.be.a(algorithmhub.InlineResponseDefault);
    });
