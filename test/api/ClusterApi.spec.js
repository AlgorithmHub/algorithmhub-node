...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new algorithmhub.ClusterApi();
  });
  ...
  describe('ClusterApi', function() {
    ...
    describe('detailCluster', function() {
      it('should call detailCluster successfully', function(done) {
        //uncomment below and update the code to test detailCluster
        //instance.detailCluster(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
